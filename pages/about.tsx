            ...
            <main className={`${s.main} w-full min-h-[90vh] flex items-center justify-center`}>
                <div className={`${s.box} flex items-center gap-10 justify-center p-20`}>
                    ...
                    <section className={`${s.description} text-white px-10 w-[60%] flex flex-col`}>
                        ...
                        <h2 className={`${s} text-[1.6rem] font-bold my-3`}>Why I choose Front-End ?</h2>
                        <p className={`${s} text-[1.4rem] text-gray-500`}>I really enjoy writing code, it seems to calm my nerves. The reason I choose Front-End is that it seems to have a life</p>
                    </section>
                </div>
            </main>
        </>
